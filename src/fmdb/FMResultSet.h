...
@property (atomic, retain, nonnull) NSString *query;

/** `NSMutableDictionary` mapping column names to numeric index */

@property (readonly, nonnull) NSMutableDictionary *columnNameToIndexMap;
...
+ (instancetype)resultSetWithStatement:(FMStatement *)statement usingParentDatabase:(nullable FMDatabase*)aDB;
